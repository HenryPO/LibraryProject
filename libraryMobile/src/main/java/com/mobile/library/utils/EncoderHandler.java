...
//		return decryptDES(ConvertUtils.bytes2HexString(data), key);
//	}
...
//		return decrypt3DES(ConvertUtils.bytes2HexString(data), key);
//	}
...
//		return decryptAES(ConvertUtils.bytes2HexString(data), key);
//	}
